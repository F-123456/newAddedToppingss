Feature:
 # a.	Confirm the additional toppings are not counted within the sauce allowance
  ...
  Scenario Outline:
    Build:
  Confirm the additional toppings are not counted within the sauce allowance
  Confirm the added toppings are available for selection to customers
  Confirm when Salami topping is selected, Salami sandwich topping is added to the cart
  Confirm when Jalapenos topping is selected, Jalapenos sandwich topping is added to the cart
  Confirm maximum number of topping that can be added to the build of sandwich is 5


Examples:
|Sandwiches|Add to Cart|
|Single Sandwich|Add to Cart|
|Double Sandwich|Salami Toppings|Jalapeños Toppings|Maximum of 5 toppings|
